...
| pattern | `RejectPendingAVModal` | PR #107 |
| atom | `Footer` | PR #82 |
...
| AV modals (audit batch 4) | `HandoffAVModal` (#106), `ReviewAVModal`, `ChangeLogModal` — see [figma-audit.md](figma-audit.md) batch 4 for specs and order |
