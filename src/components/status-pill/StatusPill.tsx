...
/**
 * StatusPill — an Added Value's status, worn as a pill: a `Badge` (same
 * sizes, same tonal pairs, same contrast numbers) plus the status dot. It
 * exists to own VCP's status vocabulary and the status → tone mapping that
