...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'An Added Value’s status as a pill — the first pattern, and the owner of VCP’s ' +
          'status vocabulary and its status → tone mapping (which docs/badge.md promised ' +
          'would live here, out of `src/components/`). Visually it *is* a Badge plus the ' +
          'status dot. Not clickable by design: changing status is the options dropdown’s job.',
      },
    },
  },
