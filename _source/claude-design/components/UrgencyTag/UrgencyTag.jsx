...
export const URGENCIES={Low:{bg:'rgb(241,245,249)',fg:'rgb(100,116,139)',fire:0},
 Medium:{bg:'rgb(254,243,199)',fg:'rgb(146,84,14)',fire:0},
 High:{bg:'rgb(255,237,213)',fg:'rgb(194,65,12)',fire:1},
 Critical:{bg:'rgb(254,226,226)',fg:'rgb(185,28,28)',fire:2},
 'Due soon':{bg:'rgb(236,238,254)',fg:'rgb(79,70,229)',fire:0}};
export function UrgencyTag({ urgency='Medium', style }) {
  const G=(typeof window!=='undefined'&&window['VCPAddedValueDesignSystem_8e42bb'])||{}; const Icon=G.Icon;
  const c=URGENCIES[urgency]||URGENCIES.Medium;
  return React.createElement('span',{style:{display:'inline-flex',alignItems:'center',gap:4,height:22,
    padding:'0 8px',borderRadius:6,background:c.bg,color:c.fg,font:'500 11px/1 '+t.font,whiteSpace:'nowrap',...style}},
    c.fire>0 && Icon && Array.from({length:c.fire}).map((_,i)=>React.createElement(Icon,{key:i,name:'fire',size:12})),
    urgency);
}